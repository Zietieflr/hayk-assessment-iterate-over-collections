...
####
biggest_company = companies.reduce { |biggest_company, company|
  biggest_company.size > company.size ? biggest_company : company
}
puts biggest_company.name;

####
sorted_companies = companies.sort_by(&:size)
